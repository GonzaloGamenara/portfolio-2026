  ...
  return (
    <BrowserRouter>
      <div className="min-h-screen p-4 md:p-8 flex items-center justify-center">
        ...
        <div 
          className="w-[70vw] max-w-400px h-[80vh] border-[2px] border-black shadow-neo flex flex-col md:flex-row overflow-hidden bg-neo-green transition-colors duration-300"
