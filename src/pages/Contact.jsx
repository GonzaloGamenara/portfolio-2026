  ...
  return (
    <main className="flex-1 p-6 md:p-10 overflow-y-auto animate-slide-up">
      <div className="mb-8 border-b-[3px] border-black pb-4">
        ...
        <p className="font-medium mt-2">Hablemos de tu próximo proyecto. Dejame tu mensaje y te escribo.</p>
      </div>
      ...
      <div className="bg-neo-yellow border-[3px] border-black shadow-neo p-6 md:p-10 max-w-2xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="email" className="font-bold text-sm">Tu Email</label>
            <input 
              type="email" 
              name="email" 
              id="email" 
          ...
          <button 
            type="submit"
            className="bg-black text-white font-black text-xl py-4 border-[3px] border-black shadow-neo hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none hover:bg-gray-800 transition-all mt-4"
          >
            Enviar Mensaje
          </button>
        </form>
